...
VALUES (usr('therapist@trainer-advisor.pro'), client('Бортник'), appnt_type('Тренировка'), thrp_task('Мобилизация ПОП'),
        current_date - '6 days 9 hours 30 minutes'::INTERVAL, 'Asia/Novosibirsk', 'Freedom Yoga', 2000, false,
        null,
        now(), null, 1, '1 HOUR', 'PENDING'),
       (usr('therapist@trainer-advisor.pro'), client('Королёва'), appnt_type('Консультация'), thrp_task('ЙТ гастрита'),
        current_date - '6 days 11 hours 15 minutes'::INTERVAL, 'Europe/Moscow', 'Онлайн', 18000, true, null,
        now(), null, 1, '1 HOUR', 'PENDING'),

       (usr('therapist@trainer-advisor.pro'), client('Бортник'), appnt_type('Тренировка'), thrp_task('Мобилизация ПОП'),
