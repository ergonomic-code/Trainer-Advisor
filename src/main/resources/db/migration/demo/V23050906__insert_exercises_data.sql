...
VALUES ('Разминка для шеи', '', '', '', '00:10:00', 1, 2),
       ('ПИР на верхние трапеции', '', '', '', '00:10:00', 4, 2),
       ('ПИР на ременные мышцы шеи и головы', '', '', '', '00:10:00', 4, 2),
       ('Укрепление глубоких сгибателей шеи', '', '', '', '00:04:00', 3, 2),
       ('Тракция и расслабление шеи в шавасане', '', '', '', '00:15:00', 6, 2);
...
INSERT INTO exercise_steps(description, image_id, exercise_id, step_index)
