...
После этого приложение будет доступно по URL http://localhost:8080, а все изменения в директории
src/main/resources/static будут видимы сразу после сохранения файла.
